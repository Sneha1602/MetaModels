 ...
 * @generated
 */
public class EssentialIFMLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EssentialIFMLPackage.ESSENTIAL_IFML_MODEL: {
				EssentialIFMLModel essentialIFMLModel = (EssentialIFMLModel)theEObject;
				T result = caseEssentialIFMLModel(essentialIFMLModel);
				if (result == null) result = caseNamedElement(essentialIFMLModel);
			...
			case EssentialIFMLPackage.EVENT: {
			...
			case EssentialIFMLPackage.FIELD: {
			...
			case EssentialIFMLPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EssentialIFMLPackage.FORM: {
			...
			case EssentialIFMLPackage.DETAILS: {
			...
			case EssentialIFMLPackage.VIEW_COMPONENT: {
